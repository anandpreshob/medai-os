...
app.include_router(analytics.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(suites.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(rtstruct.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(report.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(triage.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(suv.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(batch_process.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(batch_websocket.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(exports.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(neuro_analytics.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(neuro_longitudinal.router, prefix=settings.MONAI_LABEL_API_STR)
app.include_router(neuro_qc.router, prefix=settings.MONAI_LABEL_API_STR)
